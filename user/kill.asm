...
ugetpid(void)
{
 ...
 2d6:	17f5                	addi	a5,a5,-3 # 3fffffd <__global_pointer$+0x3ffeb71>
...
free(void *ap)
{
 ...
 6a6:	5ee7b783          	ld	a5,1518(a5) # c90 <freep>
 ...
 6ce:	00e6ea63          	bltu	a3,a4,6e2 <free+0x4a>
{
 ...
 710:	58f73223          	sd	a5,1412(a4) # c90 <freep>
}
 714:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 76a:	52a90913          	addi	s2,s2,1322 # c90 <freep>
  if(p == (char*)-1)
 76e:	5afd                	li	s5,-1
 ...
 77e:	51e78793          	addi	a5,a5,1310 # c98 <base>
 782:	00000717          	auipc	a4,0x0
 786:	50f73723          	sd	a5,1294(a4) # c90 <freep>
 78a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7fc:	48a73c23          	sd	a0,1176(a4) # c90 <freep>
      return (void*)(p + 1);
