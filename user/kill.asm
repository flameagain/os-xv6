...
free(void *ap)
{
 ...
 680:	6bc7b783          	ld	a5,1724(a5) # d38 <freep>
 ...
 6a8:	00e6ea63          	bltu	a3,a4,6bc <free+0x4a>
{
 ...
 6ea:	64f73923          	sd	a5,1618(a4) # d38 <freep>
}
 6ee:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 714:	62853503          	ld	a0,1576(a0) # d38 <freep>
 ...
 744:	5f890913          	addi	s2,s2,1528 # d38 <freep>
  if(p == (char*)-1)
 748:	5afd                	li	s5,-1
 ...
 758:	5ec78793          	addi	a5,a5,1516 # d40 <base>
 75c:	00000717          	auipc	a4,0x0
 760:	5cf73e23          	sd	a5,1500(a4) # d38 <freep>
 764:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7d6:	56a73323          	sd	a0,1382(a4) # d38 <freep>
      return (void*)(p + 1);
