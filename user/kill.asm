...
free(void *ap)
{
 ...
 688:	5cc7b783          	ld	a5,1484(a5) # c50 <freep>
 ...
 6b0:	00e6ea63          	bltu	a3,a4,6c4 <free+0x4a>
{
 ...
 6f2:	56f73123          	sd	a5,1378(a4) # c50 <freep>
}
 6f6:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 71c:	53853503          	ld	a0,1336(a0) # c50 <freep>
 ...
 74c:	50890913          	addi	s2,s2,1288 # c50 <freep>
  if(p == (char*)-1)
 750:	5afd                	li	s5,-1
 ...
 760:	4fc78793          	addi	a5,a5,1276 # c58 <base>
 764:	00000717          	auipc	a4,0x0
 768:	4ef73623          	sd	a5,1260(a4) # c50 <freep>
 76c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7de:	46a73b23          	sd	a0,1142(a4) # c50 <freep>
      return (void*)(p + 1);
