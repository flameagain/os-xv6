...
err(char *why)
{
  ...
  12:	f8a93903          	ld	s2,-118(s2) # f98 <testname>
...
ugetpid_test()
{
  ...
  64:	f2f73c23          	sd	a5,-200(a4) # f98 <testname>
...
pgaccess_test()
{
 ...
 10a:	e8f73923          	sd	a5,-366(a4) # f98 <testname>
 ...
 134:	0007c703          	lbu	a4,0(a5) # 1000 <__BSS_END__+0x48>
 138:	2705                	addiw	a4,a4,1
 13a:	00e78023          	sb	a4,0(a5)
  buf[PGSIZE * 2] += 1;
 13e:	6789                	lui	a5,0x2
 140:	97a6                	add	a5,a5,s1
 142:	0007c703          	lbu	a4,0(a5) # 2000 <__global_pointer$+0x86c>
 146:	2705                	addiw	a4,a4,1
 148:	00e78023          	sb	a4,0(a5)
  buf[PGSIZE * 30] += 1;
 14c:	67f9                	lui	a5,0x1e
 14e:	97a6                	add	a5,a5,s1
 150:	0007c703          	lbu	a4,0(a5) # 1e000 <__global_pointer$+0x1c86c>
 ...
 178:	0799                	addi	a5,a5,6 # 40000006 <__global_pointer$+0x3fffe872>
...
ugetpid(void)
{
 ...
 472:	17f5                	addi	a5,a5,-3 # 3fffffd <__global_pointer$+0x3ffe869>
...
free(void *ap)
{
 ...
 842:	7627b783          	ld	a5,1890(a5) # fa0 <freep>
 ...
 86a:	00e6ea63          	bltu	a3,a4,87e <free+0x4a>
{
 ...
 8ac:	6ef73c23          	sd	a5,1784(a4) # fa0 <freep>
}
 8b0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 8d6:	6ce53503          	ld	a0,1742(a0) # fa0 <freep>
 ...
 906:	69e90913          	addi	s2,s2,1694 # fa0 <freep>
  if(p == (char*)-1)
 90a:	5afd                	li	s5,-1
 ...
 91a:	69278793          	addi	a5,a5,1682 # fa8 <base>
 91e:	00000717          	auipc	a4,0x0
 922:	68f73123          	sd	a5,1666(a4) # fa0 <freep>
 926:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 998:	60a73623          	sd	a0,1548(a4) # fa0 <freep>
      return (void*)(p + 1);
