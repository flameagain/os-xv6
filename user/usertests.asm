...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	a5878793          	addi	a5,a5,-1448 # aab0 <uninit>
      60:	0000d697          	auipc	a3,0xd
      64:	16068693          	addi	a3,a3,352 # d1c0 <buf>
    if(uninit[i] != '\0'){
...
0000000000000264 <bigwrite>:
{
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     29c:	f28a0a13          	addi	s4,s4,-216 # d1c0 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2a0:	6b0d                	lui	s6,0x3
...
0000000000000818 <writetest>:
{
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8b6:	90e58593          	addi	a1,a1,-1778 # d1c0 <buf>
...
00000000000009a8 <writebig>:
{
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9d8:	7ec90913          	addi	s2,s2,2028 # d1c0 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2a:	79a90913          	addi	s2,s2,1946 # d1c0 <buf>
  if(fd < 0){
...
0000000000000b5e <unlinkread>:
{
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c06:	5be58593          	addi	a1,a1,1470 # d1c0 <buf>
     c0a:	8526                	mv	a0,s1
...
0000000000000d14 <linktest>:
{
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     dde:	3e658593          	addi	a1,a1,998 # d1c0 <buf>
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1144:	b5b48493          	addi	s1,s1,-1189 # ffffffffeaeb0b5b <__BSS_END__+0xffffffffeaea098b>
...
badarg(char *s)
{
    ...
    1184:	35048493          	addi	s1,s1,848 # c350 <uninit+0x18a0>
...
00000000000011ba <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    124e:	00009797          	auipc	a5,0x9
    1252:	85a78793          	addi	a5,a5,-1958 # 9aa8 <big.0>
    1256:	0000a697          	auipc	a3,0xa
    125a:	85268693          	addi	a3,a3,-1966 # aaa8 <__global_pointer$+0x90c>
      big[i] = 'x';
    ...
    big[PGSIZE] = '\0';
    126c:	0000a797          	auipc	a5,0xa
    1270:	82078e23          	sb	zero,-1988(a5) # aaa8 <__global_pointer$+0x90c>
...
0000000000001758 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    17a0:	a24a8a93          	addi	s5,s5,-1500 # d1c0 <buf>
    17a4:	864a                	mv	a2,s2
    17a6:	85d6                	mv	a1,s5
    ...
    17bc:	a0870713          	addi	a4,a4,-1528 # d1c0 <buf>
    ...
    182e:	996b0b13          	addi	s6,s6,-1642 # d1c0 <buf>
...
0000000000001de4 <linkunlink>:
{
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e2e:	e6da0a1b          	addiw	s4,s4,-403 # 41c64e6d <__BSS_END__+0x41c54c9d>
...
0000000000001ee8 <manywrites>:
{
  ...
  exit(0);
    ...
    1f8e:	236b0b13          	addi	s6,s6,566 # d1c0 <buf>
...
0000000000002118 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2134:	35098993          	addi	s3,s3,848 # c350 <uninit+0x18a0>
    2138:	1003d937          	lui	s2,0x1003d
    213c:	090e                	slli	s2,s2,0x3
    213e:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002d2b0>
    pid = fork();
...
0000000000002272 <bigargtest>:
{
  ...
  close(fd);
    ...
    22da:	6d278793          	addi	a5,a5,1746 # 99a8 <args.1>
    22de:	00007697          	auipc	a3,0x7
    22e2:	7c268693          	addi	a3,a3,1986 # 9aa0 <args.1+0xf8>
    ...
    22fa:	6b258593          	addi	a1,a1,1714 # 99a8 <args.1>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    23b6:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xfffffffffffeee30>
    23ba:	85a6                	mv	a1,s1
...
00000000000026a6 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    26e2:	6705                	lui	a4,0x1
      *b = 99;
    26e4:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3ffefe30>
    for(b = a; b < a+TOOMUCH; b += 4096){
...
0000000000002844 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    28a6:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63efe2f>
  a = sbrk(0);
    28aa:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    290a:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63efe2f>
...
0000000000002b4a <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2c10:	8007879b          	addiw	a5,a5,-2048 # a800 <__global_pointer$+0x664>
...
0000000000002d34 <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2d40:	0511                	addi	a0,a0,4 # ffffffff80000004 <__BSS_END__+0xffffffff7ffefe34>
...
0000000000003266 <subdir>:
{
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    334a:	e7a58593          	addi	a1,a1,-390 # d1c0 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3360:	e6474703          	lbu	a4,-412(a4) # d1c0 <buf>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    342a:	d9a58593          	addi	a1,a1,-614 # d1c0 <buf>
...
000000000000418a <preempt>:
{
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    428c:	f3858593          	addi	a1,a1,-200 # d1c0 <buf>
...
00000000000043de <sbrkfail>:
{
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    455e:	6705                	lui	a4,0x1
      n += *(a+i);
    4560:	0007c683          	lbu	a3,0(a5) # 6400000 <__BSS_END__+0x63efe30>
...
00000000000047fc <fourfiles>:
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    489c:	928a0a13          	addi	s4,s4,-1752 # d1c0 <buf>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4998:	00009797          	auipc	a5,0x9
    499c:	82878793          	addi	a5,a5,-2008 # d1c0 <buf>
...
0000000000004d84 <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4dc4:	40090913          	addi	s2,s2,1024 # d1c0 <buf>
  for(i = 0; i < N; i++){
    4dc8:	4a51                	li	s4,20
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4e22:	3a290913          	addi	s2,s2,930 # d1c0 <buf>
  if(fd < 0){
...
0000000000004f64 <fsfull>:
{
  ...
  printf("fsfull test finished\n");
    ...
    50b8:	10ca8a93          	addi	s5,s5,268 # d1c0 <buf>
      if(cc < BSIZE)
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    5c80:	d247b783          	ld	a5,-732(a5) # 99a0 <freep>
    ...
    5ca8:	00e6ea63          	bltu	a3,a4,5cbc <free+0x4a>
{
  ...
  freep = p;
    ...
    5cea:	caf73d23          	sd	a5,-838(a4) # 99a0 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    5d14:	c9053503          	ld	a0,-880(a0) # 99a0 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    5d44:	c6090913          	addi	s2,s2,-928 # 99a0 <freep>
  if(p == (char*)-1)
    5d48:	5afd                	li	s5,-1
    ...
    5d58:	46c78793          	addi	a5,a5,1132 # 101c0 <base>
    5d5c:	00004717          	auipc	a4,0x4
    5d60:	c4f73223          	sd	a5,-956(a4) # 99a0 <freep>
  ...
  if(p == (char*)-1)
    ...
    5dd6:	bca73723          	sd	a0,-1074(a4) # 99a0 <freep>
      return (void*)(p + 1);
