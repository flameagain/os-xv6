...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     400:	86c98993          	addi	s3,s3,-1940 # 1c68 <whitespace>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     466:	80698993          	addi	s3,s3,-2042 # 1c68 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4d2:	79a98993          	addi	s3,s3,1946 # 1c68 <whitespace>
     4d6:	00001a97          	auipc	s5,0x1
     4da:	78aa8a93          	addi	s5,s5,1930 # 1c60 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     548:	72498993          	addi	s3,s3,1828 # 1c68 <whitespace>
...
0000000000000a6c <main>:
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     aa6:	1d648493          	addi	s1,s1,470 # 1c78 <buf.0>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     afa:	182a0a13          	addi	s4,s4,386 # 1c78 <buf.0>
     afe:	8552                	mv	a0,s4
     ...
     b4a:	13250513          	addi	a0,a0,306 # 1c78 <buf.0>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1188:	aec7b783          	ld	a5,-1300(a5) # 1c70 <freep>
    ...
    11b0:	00e6ea63          	bltu	a3,a4,11c4 <free+0x4a>
{
  ...
  freep = p;
    ...
    11f2:	a8f73123          	sd	a5,-1406(a4) # 1c70 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    121c:	a5853503          	ld	a0,-1448(a0) # 1c70 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    1248:	00001917          	auipc	s2,0x1
    124c:	a2890913          	addi	s2,s2,-1496 # 1c70 <freep>
  if(p == (char*)-1)
    1250:	5afd                	li	s5,-1
    ...
    1260:	a8478793          	addi	a5,a5,-1404 # 1ce0 <base>
    1264:	00001717          	auipc	a4,0x1
    1268:	a0f73623          	sd	a5,-1524(a4) # 1c70 <freep>
  ...
  if(p == (char*)-1)
    ...
    12de:	98a73b23          	sd	a0,-1642(a4) # 1c70 <freep>
      return (void*)(p + 1);
