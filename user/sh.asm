...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     400:	95498993          	addi	s3,s3,-1708 # 1d50 <whitespace>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     466:	8ee98993          	addi	s3,s3,-1810 # 1d50 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4d2:	88298993          	addi	s3,s3,-1918 # 1d50 <whitespace>
     4d6:	00002a97          	auipc	s5,0x2
     4da:	872a8a93          	addi	s5,s5,-1934 # 1d48 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     548:	80c98993          	addi	s3,s3,-2036 # 1d50 <whitespace>
...
0000000000000a6c <main>:
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     aa6:	2be48493          	addi	s1,s1,702 # 1d60 <buf.0>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     afa:	26aa0a13          	addi	s4,s4,618 # 1d60 <buf.0>
     afe:	8552                	mv	a0,s4
     ...
     b4a:	21a50513          	addi	a0,a0,538 # 1d60 <buf.0>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1180:	bdc7b783          	ld	a5,-1060(a5) # 1d58 <freep>
    ...
    11a8:	00e6ea63          	bltu	a3,a4,11bc <free+0x4a>
{
  ...
  freep = p;
    ...
    11ea:	b6f73923          	sd	a5,-1166(a4) # 1d58 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1214:	b4853503          	ld	a0,-1208(a0) # 1d58 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1244:	b1890913          	addi	s2,s2,-1256 # 1d58 <freep>
  if(p == (char*)-1)
    1248:	5afd                	li	s5,-1
    ...
    1258:	b7478793          	addi	a5,a5,-1164 # 1dc8 <base>
    125c:	00001717          	auipc	a4,0x1
    1260:	aef73e23          	sd	a5,-1284(a4) # 1d58 <freep>
  ...
  if(p == (char*)-1)
    ...
    12d6:	a8a73323          	sd	a0,-1402(a4) # 1d58 <freep>
      return (void*)(p + 1);
