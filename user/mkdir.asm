...
free(void *ap)
{
 ...
 692:	6e27b783          	ld	a5,1762(a5) # d70 <freep>
 ...
 6ba:	00e6ea63          	bltu	a3,a4,6ce <free+0x4a>
{
 ...
 6fc:	66f73c23          	sd	a5,1656(a4) # d70 <freep>
}
 700:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 726:	64e53503          	ld	a0,1614(a0) # d70 <freep>
 ...
 756:	61e90913          	addi	s2,s2,1566 # d70 <freep>
  if(p == (char*)-1)
 75a:	5afd                	li	s5,-1
 ...
 76a:	61278793          	addi	a5,a5,1554 # d78 <base>
 76e:	00000717          	auipc	a4,0x0
 772:	60f73123          	sd	a5,1538(a4) # d70 <freep>
 776:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7e8:	58a73623          	sd	a0,1420(a4) # d70 <freep>
      return (void*)(p + 1);
