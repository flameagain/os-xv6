...
free(void *ap)
{
 ...
 69a:	5ea7b783          	ld	a5,1514(a5) # c80 <freep>
 ...
 6c2:	00e6ea63          	bltu	a3,a4,6d6 <free+0x4a>
{
 ...
 704:	58f73023          	sd	a5,1408(a4) # c80 <freep>
}
 708:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 72e:	55653503          	ld	a0,1366(a0) # c80 <freep>
 ...
 75e:	52690913          	addi	s2,s2,1318 # c80 <freep>
  if(p == (char*)-1)
 762:	5afd                	li	s5,-1
 ...
 772:	51a78793          	addi	a5,a5,1306 # c88 <base>
 776:	00000717          	auipc	a4,0x0
 77a:	50f73523          	sd	a5,1290(a4) # c80 <freep>
 77e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7f0:	48a73a23          	sd	a0,1172(a4) # c80 <freep>
      return (void*)(p + 1);
