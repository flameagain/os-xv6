...
free(void *ap)
{
 ...
 724:	6d87b783          	ld	a5,1752(a5) # df8 <freep>
 ...
 74c:	00e6ea63          	bltu	a3,a4,760 <free+0x4a>
{
 ...
 78e:	66f73723          	sd	a5,1646(a4) # df8 <freep>
}
 792:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7b8:	64453503          	ld	a0,1604(a0) # df8 <freep>
 ...
 7e8:	61490913          	addi	s2,s2,1556 # df8 <freep>
  if(p == (char*)-1)
 7ec:	5afd                	li	s5,-1
 ...
 7fc:	60878793          	addi	a5,a5,1544 # e00 <base>
 800:	00000717          	auipc	a4,0x0
 804:	5ef73c23          	sd	a5,1528(a4) # df8 <freep>
 808:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 87a:	58a73123          	sd	a0,1410(a4) # df8 <freep>
      return (void*)(p + 1);
