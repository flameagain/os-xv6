...
ugetpid(void)
{
 ...
 37a:	17f5                	addi	a5,a5,-3 # 3fffffd <__global_pointer$+0x3ffeab1>
...
free(void *ap)
{
 ...
 74a:	60a7b783          	ld	a5,1546(a5) # d50 <freep>
 ...
 772:	00e6ea63          	bltu	a3,a4,786 <free+0x4a>
{
 ...
 7b4:	5af73023          	sd	a5,1440(a4) # d50 <freep>
}
 7b8:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7de:	57653503          	ld	a0,1398(a0) # d50 <freep>
 ...
 80e:	54690913          	addi	s2,s2,1350 # d50 <freep>
  if(p == (char*)-1)
 812:	5afd                	li	s5,-1
 ...
 822:	53a78793          	addi	a5,a5,1338 # d58 <base>
 826:	00000717          	auipc	a4,0x0
 82a:	52f73523          	sd	a5,1322(a4) # d50 <freep>
 82e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8a0:	4aa73a23          	sd	a0,1204(a4) # d50 <freep>
      return (void*)(p + 1);
