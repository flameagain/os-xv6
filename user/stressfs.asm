...
free(void *ap)
{
 ...
 72c:	5e87b783          	ld	a5,1512(a5) # d10 <freep>
 ...
 754:	00e6ea63          	bltu	a3,a4,768 <free+0x4a>
{
 ...
 796:	56f73f23          	sd	a5,1406(a4) # d10 <freep>
}
 79a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7c0:	55453503          	ld	a0,1364(a0) # d10 <freep>
 ...
 7f0:	52490913          	addi	s2,s2,1316 # d10 <freep>
  if(p == (char*)-1)
 7f4:	5afd                	li	s5,-1
 ...
 804:	51878793          	addi	a5,a5,1304 # d18 <base>
 808:	00000717          	auipc	a4,0x0
 80c:	50f73423          	sd	a5,1288(a4) # d10 <freep>
 810:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 882:	48a73923          	sd	a0,1170(a4) # d10 <freep>
      return (void*)(p + 1);
