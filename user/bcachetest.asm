...
int ntas(int print)
{
 ...
 1b6:	2b650513          	addi	a0,a0,694 # 1468 <buf>
 ...
 1ce:	29e50513          	addi	a0,a0,670 # 1468 <buf>
 ...
 210:	25c58593          	addi	a1,a1,604 # 1468 <buf>
...
test0()
{
 ...
 3ae:	4605                	li	a2,1
 3b0:	658d                	lui	a1,0x3
 3b2:	80058593          	addi	a1,a1,-2048 # 2800 <__BSS_END__+0x388>
...
strcpy(char *s, const char *t)
{
 ...
 55a:	0800                	addi	s0,sp,16
  ...
  while((*s++ = *t++) != 0)
 55c:	87aa                	mv	a5,a0
 55e:	0585                	addi	a1,a1,1 # 19001 <__BSS_END__+0x16b89>
...
free(void *ap)
{
 ...
 b6e:	8f67b783          	ld	a5,-1802(a5) # 1460 <freep>
 ...
 b96:	00e6ea63          	bltu	a3,a4,baa <free+0x4a>
{
 ...
 bd8:	88f73623          	sd	a5,-1908(a4) # 1460 <freep>
}
 bdc:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 bfc:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
 bfe:	00001517          	auipc	a0,0x1
 c02:	86253503          	ld	a0,-1950(a0) # 1460 <freep>
 ...
 c2a:	004a1a1b          	slliw	s4,s4,0x4
    ...
    if(p == freep)
 c2e:	00001917          	auipc	s2,0x1
 c32:	83290913          	addi	s2,s2,-1998 # 1460 <freep>
  if(p == (char*)-1)
 c36:	5afd                	li	s5,-1
 ...
 c40:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
 c42:	00002797          	auipc	a5,0x2
 c46:	82678793          	addi	a5,a5,-2010 # 2468 <base>
 c4a:	00001717          	auipc	a4,0x1
 c4e:	80f73b23          	sd	a5,-2026(a4) # 1460 <freep>
 c52:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 cc4:	7aa73023          	sd	a0,1952(a4) # 1460 <freep>
      return (void*)(p + 1);
