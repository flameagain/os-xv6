 ...
 */
    ...
    lo = x % 127773;
      16:	66fd                	lui	a3,0x1f
      18:	31d68693          	addi	a3,a3,797 # 1f31d <__global_pointer$+0x1cec1>
      1c:	02d7e733          	rem	a4,a5,a3
    x = 16807 * lo - 2836 * hi;
      20:	6611                	lui	a2,0x4
      22:	1a760613          	addi	a2,a2,423 # 41a7 <__global_pointer$+0x1d4b>
      26:	02c70733          	mul	a4,a4,a2
    hi = x / 127773;
      2a:	02d7c7b3          	div	a5,a5,a3
    x = 16807 * lo - 2836 * hi;
      2e:	76fd                	lui	a3,0xfffff
      30:	4ec68693          	addi	a3,a3,1260 # fffffffffffff4ec <__global_pointer$+0xffffffffffffd090>
...
rand(void)
{
    ...
    return (do_rand(&rand_next));
      ...
      64:	c0050513          	addi	a0,a0,-1024 # 1c60 <rand_next>
...
go(int which_child)
{
  ...
  int fd = -1;
    ...
    int what = rand() % 23;
     ...
     236:	a3e58593          	addi	a1,a1,-1474 # 1c70 <buf.0>
     23a:	8552                	mv	a0,s4
     ...
     24e:	a2658593          	addi	a1,a1,-1498 # 1c70 <buf.0>
     252:	8552                	mv	a0,s4
...
iter()
{
  ...
  if(pid1 == 0){
    ...
    rand_next = 31;
     ...
     aae:	1af73b23          	sd	a5,438(a4) # 1c60 <rand_next>
    go(0);
     ab2:	4501                	li	a0,0
  ...
  if(pid2 == 0){
    ...
    rand_next = 7177;
     aec:	6789                	lui	a5,0x2
     aee:	c0978793          	addi	a5,a5,-1015 # 1c09 <digits+0x471>
     af2:	00001717          	auipc	a4,0x1
     af6:	16f73723          	sd	a5,366(a4) # 1c60 <rand_next>
    go(1);
     afa:	4505                	li	a0,1
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    11b6:	ab67b783          	ld	a5,-1354(a5) # 1c68 <freep>
    ...
    11de:	00e6ea63          	bltu	a3,a4,11f2 <free+0x4a>
{
  ...
  freep = p;
    ...
    1220:	a4f73623          	sd	a5,-1460(a4) # 1c68 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    124a:	a2253503          	ld	a0,-1502(a0) # 1c68 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    127a:	9f290913          	addi	s2,s2,-1550 # 1c68 <freep>
  if(p == (char*)-1)
    127e:	5afd                	li	s5,-1
    ...
    128e:	dce78793          	addi	a5,a5,-562 # 2058 <base>
    1292:	00001717          	auipc	a4,0x1
    1296:	9cf73b23          	sd	a5,-1578(a4) # 1c68 <freep>
  ...
  if(p == (char*)-1)
    ...
    130c:	96a73023          	sd	a0,-1696(a4) # 1c68 <freep>
      return (void*)(p + 1);
