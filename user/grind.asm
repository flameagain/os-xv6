 ...
 */
    ...
    lo = x % 127773;
      16:	66fd                	lui	a3,0x1f
      18:	31d68693          	addi	a3,a3,797 # 1f31d <__global_pointer$+0x1cf99>
      1c:	02d7e733          	rem	a4,a5,a3
    x = 16807 * lo - 2836 * hi;
      20:	6611                	lui	a2,0x4
      22:	1a760613          	addi	a2,a2,423 # 41a7 <__global_pointer$+0x1e23>
      26:	02c70733          	mul	a4,a4,a2
    hi = x / 127773;
      2a:	02d7c7b3          	div	a5,a5,a3
    x = 16807 * lo - 2836 * hi;
      2e:	76fd                	lui	a3,0xfffff
      30:	4ec68693          	addi	a3,a3,1260 # fffffffffffff4ec <__global_pointer$+0xffffffffffffd168>
...
rand(void)
{
    ...
    return (do_rand(&rand_next));
      ...
      64:	b2850513          	addi	a0,a0,-1240 # 1b88 <rand_next>
...
go(int which_child)
{
  ...
  int fd = -1;
    ...
    int what = rand() % 23;
     ...
     236:	96658593          	addi	a1,a1,-1690 # 1b98 <buf.0>
     23a:	8552                	mv	a0,s4
     ...
     24e:	94e58593          	addi	a1,a1,-1714 # 1b98 <buf.0>
     252:	8552                	mv	a0,s4
     ...
     3b4:	a5a080e7          	jalr	-1446(ra) # e0a <exit>
      ...
      sbrk(6011);
     3b8:	6505                	lui	a0,0x1
     3ba:	77b50513          	addi	a0,a0,1915 # 177b <digits+0x7b>
...
iter()
{
  ...
  if(pid1 == 0){
    ...
    rand_next = 31;
     ...
     aae:	0cf73f23          	sd	a5,222(a4) # 1b88 <rand_next>
    go(0);
     ab2:	4501                	li	a0,0
  ...
  if(pid2 == 0){
    ...
    rand_next = 7177;
     aec:	6789                	lui	a5,0x2
     aee:	c0978793          	addi	a5,a5,-1015 # 1c09 <buf.0+0x71>
     af2:	00001717          	auipc	a4,0x1
     af6:	08f73b23          	sd	a5,150(a4) # 1b88 <rand_next>
    go(1);
     afa:	4505                	li	a0,1
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    11be:	9d67b783          	ld	a5,-1578(a5) # 1b90 <freep>
    ...
    11e6:	00e6ea63          	bltu	a3,a4,11fa <free+0x4a>
{
  ...
  freep = p;
    ...
    1228:	96f73623          	sd	a5,-1684(a4) # 1b90 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1252:	94253503          	ld	a0,-1726(a0) # 1b90 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    127e:	00001917          	auipc	s2,0x1
    1282:	91290913          	addi	s2,s2,-1774 # 1b90 <freep>
  if(p == (char*)-1)
    1286:	5afd                	li	s5,-1
    ...
    1296:	cee78793          	addi	a5,a5,-786 # 1f80 <base>
    129a:	00001717          	auipc	a4,0x1
    129e:	8ef73b23          	sd	a5,-1802(a4) # 1b90 <freep>
  ...
  if(p == (char*)-1)
    ...
    1314:	88a73023          	sd	a0,-1920(a4) # 1b90 <freep>
      return (void*)(p + 1);
