...
free(void *ap)
{
 ...
 642:	69a7b783          	ld	a5,1690(a5) # cd8 <freep>
 ...
 66a:	00e6ea63          	bltu	a3,a4,67e <free+0x4a>
{
 ...
 6ac:	62f73823          	sd	a5,1584(a4) # cd8 <freep>
}
 6b0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 6d6:	60653503          	ld	a0,1542(a0) # cd8 <freep>
 ...
 706:	5d690913          	addi	s2,s2,1494 # cd8 <freep>
  if(p == (char*)-1)
 70a:	5afd                	li	s5,-1
 ...
 71a:	5ca78793          	addi	a5,a5,1482 # ce0 <base>
 71e:	00000717          	auipc	a4,0x0
 722:	5af73d23          	sd	a5,1466(a4) # cd8 <freep>
 726:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 798:	54a73223          	sd	a0,1348(a4) # cd8 <freep>
      return (void*)(p + 1);
