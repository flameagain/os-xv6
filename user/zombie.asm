...
free(void *ap)
{
 ...
 64a:	5aa7b783          	ld	a5,1450(a5) # bf0 <freep>
 ...
 672:	00e6ea63          	bltu	a3,a4,686 <free+0x4a>
{
 ...
 6b4:	54f73023          	sd	a5,1344(a4) # bf0 <freep>
}
 6b8:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 6de:	51653503          	ld	a0,1302(a0) # bf0 <freep>
 ...
 70e:	4e690913          	addi	s2,s2,1254 # bf0 <freep>
  if(p == (char*)-1)
 712:	5afd                	li	s5,-1
 ...
 722:	4da78793          	addi	a5,a5,1242 # bf8 <base>
 726:	00000717          	auipc	a4,0x0
 72a:	4cf73523          	sd	a5,1226(a4) # bf0 <freep>
 72e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7a0:	44a73a23          	sd	a0,1108(a4) # bf0 <freep>
      return (void*)(p + 1);
