...
wc(int fd, char *name)
{
  ...
  32:	de2d8d93          	addi	s11,s11,-542 # e10 <buf>
    for(i=0; i<n; i++){
      c++;
      if(buf[i] == '\n')
  36:	4aa9                	li	s5,10
  ...
  8e:	d8648493          	addi	s1,s1,-634 # e10 <buf>
...
free(void *ap)
{
 ...
 7b0:	65c7b783          	ld	a5,1628(a5) # e08 <freep>
 ...
 7d8:	00e6ea63          	bltu	a3,a4,7ec <free+0x4a>
{
 ...
 81a:	5ef73923          	sd	a5,1522(a4) # e08 <freep>
}
 81e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 844:	5c853503          	ld	a0,1480(a0) # e08 <freep>
 ...
 874:	59890913          	addi	s2,s2,1432 # e08 <freep>
  if(p == (char*)-1)
 878:	5afd                	li	s5,-1
 ...
 890:	56f73e23          	sd	a5,1404(a4) # e08 <freep>
 894:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 906:	50a73323          	sd	a0,1286(a4) # e08 <freep>
      return (void*)(p + 1);
