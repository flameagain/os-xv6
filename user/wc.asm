...
wc(int fd, char *name)
{
  ...
  32:	ecad8d93          	addi	s11,s11,-310 # ef8 <buf>
    for(i=0; i<n; i++){
      c++;
      if(buf[i] == '\n')
  36:	4aa9                	li	s5,10
  ...
  8e:	e6e48493          	addi	s1,s1,-402 # ef8 <buf>
...
free(void *ap)
{
 ...
 7a8:	74c7b783          	ld	a5,1868(a5) # ef0 <freep>
 ...
 7d0:	00e6ea63          	bltu	a3,a4,7e4 <free+0x4a>
{
 ...
 812:	6ef73123          	sd	a5,1762(a4) # ef0 <freep>
}
 816:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 83c:	6b853503          	ld	a0,1720(a0) # ef0 <freep>
 ...
 86c:	68890913          	addi	s2,s2,1672 # ef0 <freep>
  if(p == (char*)-1)
 870:	5afd                	li	s5,-1
 ...
 880:	87c78793          	addi	a5,a5,-1924 # 10f8 <base>
 884:	00000717          	auipc	a4,0x0
 888:	66f73623          	sd	a5,1644(a4) # ef0 <freep>
 88c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8fe:	5ea73b23          	sd	a0,1526(a4) # ef0 <freep>
      return (void*)(p + 1);
