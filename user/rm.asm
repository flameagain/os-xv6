...
free(void *ap)
{
 ...
 692:	6da7b783          	ld	a5,1754(a5) # d68 <freep>
 ...
 6ba:	00e6ea63          	bltu	a3,a4,6ce <free+0x4a>
{
 ...
 6fc:	66f73823          	sd	a5,1648(a4) # d68 <freep>
}
 700:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 726:	64653503          	ld	a0,1606(a0) # d68 <freep>
 ...
 756:	61690913          	addi	s2,s2,1558 # d68 <freep>
  if(p == (char*)-1)
 75a:	5afd                	li	s5,-1
 ...
 76a:	60a78793          	addi	a5,a5,1546 # d70 <base>
 76e:	00000717          	auipc	a4,0x0
 772:	5ef73d23          	sd	a5,1530(a4) # d68 <freep>
 776:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7e8:	58a73223          	sd	a0,1412(a4) # d68 <freep>
      return (void*)(p + 1);
