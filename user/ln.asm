...
free(void *ap)
{
 ...
 682:	5e27b783          	ld	a5,1506(a5) # c60 <freep>
 ...
 6aa:	00e6ea63          	bltu	a3,a4,6be <free+0x4a>
{
 ...
 6ec:	56f73c23          	sd	a5,1400(a4) # c60 <freep>
}
 6f0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 716:	54e53503          	ld	a0,1358(a0) # c60 <freep>
 ...
 746:	51e90913          	addi	s2,s2,1310 # c60 <freep>
  if(p == (char*)-1)
 74a:	5afd                	li	s5,-1
 ...
 75a:	51278793          	addi	a5,a5,1298 # c68 <base>
 75e:	00000717          	auipc	a4,0x0
 762:	50f73123          	sd	a5,1282(a4) # c60 <freep>
 766:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7d8:	48a73623          	sd	a0,1164(a4) # c60 <freep>
      return (void*)(p + 1);
