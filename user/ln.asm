...
free(void *ap)
{
 ...
 67a:	6d27b783          	ld	a5,1746(a5) # d48 <freep>
 ...
 6a2:	00e6ea63          	bltu	a3,a4,6b6 <free+0x4a>
{
 ...
 6e4:	66f73423          	sd	a5,1640(a4) # d48 <freep>
}
 6e8:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 70e:	63e53503          	ld	a0,1598(a0) # d48 <freep>
 ...
 73e:	60e90913          	addi	s2,s2,1550 # d48 <freep>
  if(p == (char*)-1)
 742:	5afd                	li	s5,-1
 ...
 752:	60278793          	addi	a5,a5,1538 # d50 <base>
 756:	00000717          	auipc	a4,0x0
 75a:	5ef73923          	sd	a5,1522(a4) # d48 <freep>
 75e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7d0:	56a73e23          	sd	a0,1404(a4) # d48 <freep>
      return (void*)(p + 1);
