...
fmtname(char *path)
{
  ...
  66:	f4698993          	addi	s3,s3,-186 # fa8 <buf.0>
...
free(void *ap)
{
 ...
 8f8:	6ac7b783          	ld	a5,1708(a5) # fa0 <freep>
 ...
 920:	00e6ea63          	bltu	a3,a4,934 <free+0x4a>
{
 ...
 962:	64f73123          	sd	a5,1602(a4) # fa0 <freep>
}
 966:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 98c:	61853503          	ld	a0,1560(a0) # fa0 <freep>
 ...
 9bc:	5e890913          	addi	s2,s2,1512 # fa0 <freep>
  if(p == (char*)-1)
 9c0:	5afd                	li	s5,-1
 ...
 9d0:	5ec78793          	addi	a5,a5,1516 # fb8 <base>
 9d4:	00000717          	auipc	a4,0x0
 9d8:	5cf73623          	sd	a5,1484(a4) # fa0 <freep>
 9dc:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a4e:	54a73b23          	sd	a0,1366(a4) # fa0 <freep>
      return (void*)(p + 1);
