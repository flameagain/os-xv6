...
fmtname(char *path)
{
  ...
  66:	02e98993          	addi	s3,s3,46 # 1090 <buf.0>
...
free(void *ap)
{
 ...
 8f0:	79c7b783          	ld	a5,1948(a5) # 1088 <freep>
 ...
 918:	00e6ea63          	bltu	a3,a4,92c <free+0x4a>
{
 ...
 95a:	72f73923          	sd	a5,1842(a4) # 1088 <freep>
}
 95e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 984:	70853503          	ld	a0,1800(a0) # 1088 <freep>
 ...
 9b4:	6d890913          	addi	s2,s2,1752 # 1088 <freep>
  if(p == (char*)-1)
 9b8:	5afd                	li	s5,-1
 ...
 9c8:	6dc78793          	addi	a5,a5,1756 # 10a0 <base>
 9cc:	00000717          	auipc	a4,0x0
 9d0:	6af73e23          	sd	a5,1724(a4) # 1088 <freep>
 9d4:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a46:	64a73323          	sd	a0,1606(a4) # 1088 <freep>
      return (void*)(p + 1);
