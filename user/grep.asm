...
000000000000011a <grep>:
{
 ...
 140:	f44a8a93          	addi	s5,s5,-188 # 1080 <buf>
 ...
 1ba:	eca50513          	addi	a0,a0,-310 # 1080 <buf>
...
free(void *ap)
{
 ...
 8c2:	7ba7b783          	ld	a5,1978(a5) # 1078 <freep>
 ...
 8ea:	00e6ea63          	bltu	a3,a4,8fe <free+0x4a>
{
 ...
 92c:	74f73823          	sd	a5,1872(a4) # 1078 <freep>
}
 930:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 956:	72653503          	ld	a0,1830(a0) # 1078 <freep>
 ...
 986:	6f690913          	addi	s2,s2,1782 # 1078 <freep>
  if(p == (char*)-1)
 98a:	5afd                	li	s5,-1
 ...
 99a:	aea78793          	addi	a5,a5,-1302 # 1480 <base>
 99e:	00000717          	auipc	a4,0x0
 9a2:	6cf73d23          	sd	a5,1754(a4) # 1078 <freep>
 9a6:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a18:	66a73223          	sd	a0,1636(a4) # 1078 <freep>
      return (void*)(p + 1);
