...
main(void)
{
  ...
  ca:	c7258593          	addi	a1,a1,-910 # d38 <argv>
...
free(void *ap)
{
 ...
 718:	6347b783          	ld	a5,1588(a5) # d48 <freep>
 ...
 740:	00e6ea63          	bltu	a3,a4,754 <free+0x4a>
{
 ...
 782:	5cf73523          	sd	a5,1482(a4) # d48 <freep>
}
 786:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7ac:	5a053503          	ld	a0,1440(a0) # d48 <freep>
 ...
 7dc:	57090913          	addi	s2,s2,1392 # d48 <freep>
  if(p == (char*)-1)
 7e0:	5afd                	li	s5,-1
 ...
 7f0:	56478793          	addi	a5,a5,1380 # d50 <base>
 7f4:	00000717          	auipc	a4,0x0
 7f8:	54f73a23          	sd	a5,1364(a4) # d48 <freep>
 7fc:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 86e:	4ca73f23          	sd	a0,1246(a4) # d48 <freep>
      return (void*)(p + 1);
