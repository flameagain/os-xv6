...
main(void)
{
  ...
  de:	d5658593          	addi	a1,a1,-682 # e30 <argv>
...
free(void *ap)
{
 ...
 724:	7207b783          	ld	a5,1824(a5) # e40 <freep>
 ...
 74c:	00e6ea63          	bltu	a3,a4,760 <free+0x4a>
{
 ...
 78e:	6af73b23          	sd	a5,1718(a4) # e40 <freep>
}
 792:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7b8:	68c53503          	ld	a0,1676(a0) # e40 <freep>
 ...
 7e8:	65c90913          	addi	s2,s2,1628 # e40 <freep>
  if(p == (char*)-1)
 7ec:	5afd                	li	s5,-1
 ...
 7fc:	65078793          	addi	a5,a5,1616 # e48 <base>
 800:	00000717          	auipc	a4,0x0
 804:	64f73023          	sd	a5,1600(a4) # e40 <freep>
 808:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 87a:	5ca73523          	sd	a0,1482(a4) # e40 <freep>
      return (void*)(p + 1);
