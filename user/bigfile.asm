...
main()
{
  ...
  if(blocks != 65803) {
  b8:	67c1                	lui	a5,0x10
  ba:	10b78793          	addi	a5,a5,267 # 1010b <__global_pointer$+0xea77>
 ...
 102:	10b98993          	addi	s3,s3,267 # 1010b <__global_pointer$+0xea77>
...
free(void *ap)
{
 ...
 7b6:	6e67b783          	ld	a5,1766(a5) # e98 <freep>
 ...
 7de:	00e6ea63          	bltu	a3,a4,7f2 <free+0x4a>
{
 ...
 820:	66f73e23          	sd	a5,1660(a4) # e98 <freep>
}
 824:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 84a:	65253503          	ld	a0,1618(a0) # e98 <freep>
 ...
 87a:	62290913          	addi	s2,s2,1570 # e98 <freep>
  if(p == (char*)-1)
 87e:	5afd                	li	s5,-1
 ...
 88e:	61678793          	addi	a5,a5,1558 # ea0 <base>
 ...
 90c:	58a73823          	sd	a0,1424(a4) # e98 <freep>
      return (void*)(p + 1);
