...
free(void *ap)
{
 ...
 6ae:	5c67b783          	ld	a5,1478(a5) # c70 <freep>
 ...
 6d6:	00e6ea63          	bltu	a3,a4,6ea <free+0x4a>
{
 ...
 718:	54f73e23          	sd	a5,1372(a4) # c70 <freep>
}
 71c:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 742:	53253503          	ld	a0,1330(a0) # c70 <freep>
 ...
 772:	50290913          	addi	s2,s2,1282 # c70 <freep>
  if(p == (char*)-1)
 776:	5afd                	li	s5,-1
 ...
 786:	4f678793          	addi	a5,a5,1270 # c78 <base>
 78a:	00000717          	auipc	a4,0x0
 78e:	4ef73323          	sd	a5,1254(a4) # c70 <freep>
 792:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 804:	46a73823          	sd	a0,1136(a4) # c70 <freep>
      return (void*)(p + 1);
