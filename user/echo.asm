...
free(void *ap)
{
 ...
 6a6:	6ae7b783          	ld	a5,1710(a5) # d50 <freep>
 ...
 6ce:	00e6ea63          	bltu	a3,a4,6e2 <free+0x4a>
{
 ...
 710:	64f73223          	sd	a5,1604(a4) # d50 <freep>
}
 714:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 73a:	61a53503          	ld	a0,1562(a0) # d50 <freep>
 ...
 76a:	5ea90913          	addi	s2,s2,1514 # d50 <freep>
  if(p == (char*)-1)
 76e:	5afd                	li	s5,-1
 ...
 77e:	5de78793          	addi	a5,a5,1502 # d58 <base>
 782:	00000717          	auipc	a4,0x0
 786:	5cf73723          	sd	a5,1486(a4) # d50 <freep>
 78a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7fc:	54a73c23          	sd	a0,1368(a4) # d50 <freep>
      return (void*)(p + 1);
