...
cat(int fd)
{
  ...
  14:	e5890913          	addi	s2,s2,-424 # e68 <buf>
...
free(void *ap)
{
 ...
 73a:	72a7b783          	ld	a5,1834(a5) # e60 <freep>
 ...
 762:	00e6ea63          	bltu	a3,a4,776 <free+0x4a>
{
 ...
 7a4:	6cf73023          	sd	a5,1728(a4) # e60 <freep>
}
 7a8:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7ce:	69653503          	ld	a0,1686(a0) # e60 <freep>
 ...
 7fe:	66690913          	addi	s2,s2,1638 # e60 <freep>
  if(p == (char*)-1)
 802:	5afd                	li	s5,-1
 ...
 812:	85a78793          	addi	a5,a5,-1958 # 1068 <base>
 816:	00000717          	auipc	a4,0x0
 81a:	64f73523          	sd	a5,1610(a4) # e60 <freep>
 81e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 890:	5ca73a23          	sd	a0,1492(a4) # e60 <freep>
      return (void*)(p + 1);
