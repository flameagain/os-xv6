...
cat(int fd)
{
  ...
  14:	db090913          	addi	s2,s2,-592 # dc0 <buf>
...
ugetpid(void)
{
 ...
 390:	17f5                	addi	a5,a5,-3 # 3fffffd <__global_pointer$+0x3ffea49>
...
free(void *ap)
{
 ...
 760:	65c7b783          	ld	a5,1628(a5) # db8 <freep>
 ...
 788:	00e6ea63          	bltu	a3,a4,79c <free+0x4a>
{
 ...
 7ca:	5ef73923          	sd	a5,1522(a4) # db8 <freep>
}
 7ce:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7f4:	5c853503          	ld	a0,1480(a0) # db8 <freep>
 ...
 824:	59890913          	addi	s2,s2,1432 # db8 <freep>
  if(p == (char*)-1)
 828:	5afd                	li	s5,-1
 ...
 838:	78c78793          	addi	a5,a5,1932 # fc0 <base>
 83c:	00000717          	auipc	a4,0x0
 840:	56f73e23          	sd	a5,1404(a4) # db8 <freep>
 844:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8b6:	50a73323          	sd	a0,1286(a4) # db8 <freep>
      return (void*)(p + 1);
