...
cat(int fd)
{
  ...
  14:	d7090913          	addi	s2,s2,-656 # d80 <buf>
...
free(void *ap)
{
 ...
 742:	63a7b783          	ld	a5,1594(a5) # d78 <freep>
 ...
 76a:	00e6ea63          	bltu	a3,a4,77e <free+0x4a>
{
 ...
 7ac:	5cf73823          	sd	a5,1488(a4) # d78 <freep>
}
 7b0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7d6:	5a653503          	ld	a0,1446(a0) # d78 <freep>
 ...
 806:	57690913          	addi	s2,s2,1398 # d78 <freep>
  if(p == (char*)-1)
 80a:	5afd                	li	s5,-1
 ...
 81a:	76a78793          	addi	a5,a5,1898 # f80 <base>
 81e:	00000717          	auipc	a4,0x0
 822:	54f73d23          	sd	a5,1370(a4) # d78 <freep>
 826:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 898:	4ea73223          	sd	a0,1252(a4) # d78 <freep>
      return (void*)(p + 1);
